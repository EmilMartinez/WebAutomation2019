...
public class TestSocialMedia extends CommonAPI {
   ...
   @Test(alwaysRun = true, description = "Test #43")
   ...
   @Test(alwaysRun = true, description = "Test #44")
   ...
   @Test(alwaysRun = true, description = "Test #45")
   ...
   @Test(alwaysRun = true, description = "Test #46")
   ...
   @Test(alwaysRun = true, description = "Test #47")
   ...
   @Test(alwaysRun = true, description = "Test #48")
   ...
   @Test(alwaysRun = true, description = "Test #49")
   ...
   @Test(alwaysRun = true, description = "Test #50")
   ...
   @Test(alwaysRun = true, description = "Test #51")
   ...
   @Test(alwaysRun = true, description = "Test #52")
   ...
   @Test(alwaysRun = true, description = "Test #53")
   ...
   @Test(alwaysRun = true, description = "Test #54")
   ...
   @Test(alwaysRun = true, description = "Test #55")
   ...
   @Test(alwaysRun = true, description = "Test #56")
   ...
   @Test(alwaysRun = true, description = "Test #57")
   ...
   @Test(alwaysRun = true, description = "Test #58")
