...
public class Shows {
   ...
   @FindBy(xpath = "//body/form[@id='Default']/div[@id='sticky-header']/div/div/div/div[@class='container']/div[@class='row']/div[@class='col-sm-9 navigation-block']/div[@class='navigation']/div[@class='navbar navbar-default']/div[@class='container']/div[@class='navbar-collapse collapse']/ul[@class='nav navbar-nav']/li[5]")
   private WebElement field_shows;
   ...
   public List<String> getListOfDropdownWebElem(WebDriver driver) {
      ...
      String xpath = "//div[@id='article-main-header']//li[5]//ul[1]//li[1]//ul[1]";
   ...
   public void hoverOverShows(WebDriver driver) {
   ...
   public boolean isDropdownVisible() {
      WebElement dropdown = field_shows.findElement(By.xpath("ul[1]"));
